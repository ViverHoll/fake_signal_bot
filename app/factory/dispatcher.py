...
from app.middlewares.outer import CheckDataUserMiddleware, CheckSubMiddleware
...
def create_dispatcher(config: AppConfig) -> Dispatcher:
    ...
    dispatcher.include_routers(handlers_router, states_router, setup_all_dialogs())
