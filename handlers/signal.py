...
from func import add_text_on_photo
from keyboards.user import get_button_with_data
...
async def get_signal(callback: CallbackQuery):
    ...
    abs_path_result_photo = os.path.abspath("/root/bot_env/image/lucky_jet_new.jpg")
    ...
    add_text_on_photo(
        text=f"{random_value}",
        photo_path=os.path.abspath("/root/bot_env/image/lucky_jet.jpg"),
